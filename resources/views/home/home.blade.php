      ...
      <div class="container">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-9 text-center">
              ...
              >
              @csrf
                <input type="text" name="keyword" class="form-control px-4" placeholder="Ketik Lokasi atau Nama Kos"/>
                @if (request('c'))
                <input type="hidden" name="c" class="form-control px-4"  value="{{ request('c') }}" placeholder="Ketik Lokasi atau Nama Kos"/>
                @endif
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  {{-- <form action="https://api.whatsapp.com/send" method="GET" target="_blank">
                    <input type="hidden" name="phone" value="6285963092635">
                    <input type="hidden" name="text" value="*Halo%2C%20Admin*%20Saya%20Ingin%20tanya%20kos%20berikut%20ini%20%3A%0A%0ANama%20Kos%20%3A%20%0ALokasi%20%20%20%20%3A%20%0ACategory%20%3A%20">
                    <button type="submit" class="btn " style="background-color:#FF76E3; color:black; font-weight: bold ">Pesan Sekarang</button>
                  </form> --}}
                  
                  <a href="{{ route('show.kos', ['id'=>$item->id]) }}" class="btn " style="background-color:#FF76E3; color:black; font-weight: bold ">Pesan Sekarang</a>
                </div>
              </div>
        </div>
            @endforeach
