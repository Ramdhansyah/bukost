...
<div class="row">
  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="post" action="/admin/kos" enctype="multipart/form-data">
        @csrf
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="nama" value="{{ old('nama') }}" placeholder="Nama Kos" name="nama" autocomplete="off" autofocus>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="lokasi" value="{{ old('lokasi') }}" placeholder="Alamat Kos" name="lokasi" autocomplete="off" autofocus>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control rupiah" id="harga" value="{{ old('harga') }}" placeholder="Harga" name="harga" autocomplete="off" autofocus>
              </div>
