          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="name" value="{{ old('name', $user->name) }}" placeholder="Nama Lengkap" name="name" autocomplete="off" autofocus>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="email" value="{{ old('email',$user->email ) }}" placeholder="Email" name="email" autocomplete="off" autofocus>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="username" value="{{ old('username', $user->username) }}" placeholder="Username" name="username" autocomplete="off" autofocus>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" id="nohp" value="{{ old('nohp', $user->nohp) }}" placeholder="No. Handphone" name="nohp" autocomplete="off" autofocus>
              </div>
